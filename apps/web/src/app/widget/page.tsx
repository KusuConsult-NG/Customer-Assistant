    ...
    <div className="flex-1 flex flex-col h-screen overflow-hidden bg-black/95 text-gray-100">
      <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-black/40 backdrop-blur-md">
        <div>
          ...
          <p className="text-sm text-gray-400">Customize and embed the web chat & voice widget.</p>
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
      ...
      <div className="flex-1 overflow-hidden flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/3 p-6 overflow-y-auto border-r border-white/10 space-y-8">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-white flex items-center gap-2 uppercase tracking-widest opacity-80">
            ...
            <div>
              <label className="block text-xs font-medium text-gray-400 mb-1">Widget Position</label>
              <select
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-medium text-gray-400 mb-1">Greeting / Welcome Message</label>
              <textarea
          ...
          <div className="space-y-4 pt-4 border-t border-white/10">
            ...
            <p className="text-xs text-gray-400">Copy this code and paste it before the closing &lt;/body&gt; tag of your website.</p>
            
            <div className="relative group">
              <pre className="bg-black/60 p-4 rounded-lg overflow-x-auto text-[11px] font-mono text-gray-300 border border-white/10">
                {codeSnippet}
              </pre>
              <button
                onClick={copyCode}
                className="absolute top-2 right-2 p-1.5 rounded bg-white/10 hover:bg-white/20 text-white transition opacity-0 group-hover:opacity-100"
                title="Copy code"
              >
        ...
        <div className="flex-1 bg-white/5 relative p-6 lg:p-12 overflow-hidden flex flex-col">
          ...
          <div className="flex-1 bg-white rounded-xl overflow-hidden shadow-2xl border border-white/20 flex flex-col relative w-full h-full">
            <div className="h-14 bg-gray-100 border-b border-gray-200 flex items-center px-4 gap-4">
              ...
              <div className="flex-1 bg-white h-8 rounded border border-gray-200 flex items-center px-3 text-xs text-gray-400 font-mono">
