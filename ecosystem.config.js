...
module.exports = {
  apps: [
    ...
    {
      name: 'plaschema-qdrant',
      script: './data/qdrant/qdrant',
      args: '--uri http://localhost:6333',
      cwd: '/Users/mac/Customer Assistance',
      instances: 1,
      autorestart: true,
      watch: false,
      max_memory_restart: '256M',
      log_file: '/tmp/plaschema-qdrant.log',
      error_file: '/tmp/plaschema-qdrant-err.log',
      out_file: '/tmp/plaschema-qdrant-out.log',
    },
    {
      name: 'plaschema-web',
      script: 'npm',
